...
5. **Resolve research deliberately.** For each `research` ticket, research in a dedicated session or delegate only through an approved, available worker. Capture findings as a ticket comment with a context pointer.
